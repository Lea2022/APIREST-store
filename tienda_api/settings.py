...
SECRET_KEY = "kp$jqp9vmt8&x)j8=%(0%rwr-*vf3*z0+3@s)1t%pm0hr=@zo4"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_FILTER_BACKENDS": [
        "django_filters.rest_framework.DjangoFilterBackend",  # Para habilitar filtros
        "rest_framework.filters.SearchFilter",  # Para habilitar búsquedas
        "rest_framework.filters.OrderingFilter",  # Para habilitar ordenación
    ],
}
